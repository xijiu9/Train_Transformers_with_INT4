...
def build_xlmroberta_for_sequencePrecision(version, config, choice, xlmrobertaConfig):
    version = roberta_versions[version]
    config = roberta_configs[config]

    builder = XLMRobertaBuilder(version, config, choice)
    print("Version: {}".format(version))
    print("Config: {}".format(config))
    print("Quantize: {}".format(choice))
    print("Config: {}".format(robertaConfig))
    model = version['net'](xlmrobertaConfig, builder=builder)
...
xlmroberta_versions = {
    ...
    'RobertaForSequenceClassification': {
        'net': XLMRobertaForSequenceClassification
    }
}
